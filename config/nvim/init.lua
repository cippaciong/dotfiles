    ...
    -- Fuzzy finder
    {
      ...
      config = function()
        ...
        vim.api.nvim_set_keymap("n", "<leader>fa", [[<Cmd>lua require"fzf-lua".grep_project()<CR>]],
          { desc = 'Search all project lines' })
        vim.api.nvim_set_keymap("n", "<leader>fA", [[<Cmd>lua require"fzf-lua".live_grep()<CR>]],
          { desc = 'Live grep current project (faster but less accurate)' })
        ...
        vim.api.nvim_set_keymap("n", "<leader>fe", [[<Cmd>lua require"fzf-lua".diagnostics_document()<CR>]],
          { desc = 'Find document LSP diagnostics' })
        ...
        vim.api.nvim_set_keymap("n", "<leader>fF", [[<Cmd>lua require"fzf-lua".git_files()<CR>]],
          { desc = 'Find files in the current git project' })
        vim.api.nvim_set_keymap("n", "<leader>fg", [[<Cmd>lua require"fzf-lua".global()<CR>]],
          { desc = 'Global picker for files,buffers and symbols' })
        vim.api.nvim_set_keymap("n", "<leader>fk", [[<Cmd>lua require"fzf-lua".keymaps()<CR>]],
          { desc = 'Find keymaps' })
        vim.api.nvim_set_keymap("n", "<leader>fl", [[<Cmd>lua require"fzf-lua".lines()<CR>]],
          { desc = 'Find lines in all the open buffers' })
        vim.api.nvim_set_keymap("n", "<leader>fL", [[<Cmd>lua require"fzf-lua".blines()<CR>]],
          { desc = 'Find lines in the current buffer' })
      end
    },
